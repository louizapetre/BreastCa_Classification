...
<Stack sx={{textAlign:"left",padding:'20px',maxWidth:"800px"}} >
  ...
  <Divider sx={{marginBottom:2}}/> 
      <div>
      Select Baseline mode to build and fit a single or all five classifiers (at once) using default settings or switch to Custom mode to configure a single model's hyperparameters. Once trained, view results via the Evaluate action. Under the Optimisation tab, rank features by mutual information score and optionally retrain on a reduced feature set to compare performance.
      </div>
</Stack>
      <Stack sx={{textAlign:"left",padding:'20px',maxWidth:"800px"}} >
